...
class EncoderDNN(object):
    ...
    def fitAuto(self,x, y, SAE_list,CNN_list):
        ...
        h_floor=floor_model.fit(self.normalize_x, data_helper.oneHotEncode(self.floorID_y), epochs=self.epoch_floor, batch_size=66,
                             # validation_data=(
