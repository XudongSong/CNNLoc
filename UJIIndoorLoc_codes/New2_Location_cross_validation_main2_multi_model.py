from New2_Location_encoder_cross_validation_multi_model import EncoderDNN
import numpy as np
import data_helper
import time
import keras
...
if __name__ == '__main__':
    # Load data
    (train_x, train_y), (valid_x, valid_y), (test_x, test_y) = data_helper.load_data_all(train_csv_path, all_train_csv_path,test_csv_path)
